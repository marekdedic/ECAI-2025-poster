...
\footercontent{
	MLG @ ECML PKDD 2024, Vilnius, Lithuania \hfill
	\href{mailto:paprocha@cisco.com}{paprocha@cisco.com} \quad
	\href{mailto:marek@dedic.eu}{marek@dedic.eu} \quad
	\href{mailto:lubajer@cisco.com}{lubajer@cisco.com}
}
...
\begin{column}{\colwidth} 
    ...
    \adjustbox{width=\columnwidth}{
      \begin{tabular}{llllllll}
        \bf{Dataset} & \bf{Node} & \bf{Node label} & \bf{Hyper-edge} & \bf{\#nodes} & \bf{\#hyper-edges} & \bf{\#bip. edges} & \bf{\#classes}\\
        \midrule
